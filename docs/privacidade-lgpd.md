...
Tribunal TST: Validação de CNDT segue a LGPD (Lei nº 13.709/2018).
...
Acessar, corrigir, eliminar, portar, revogar consentimento. Contato: [tribunal_tst_validacao_cndt@mcp.ai](mailto:tribunal_tst_validacao_cndt@mcp.ai). Reclamações: [ANPD](https://www.gov.br/anpd/pt-br).
